...
public class ConvertableFields {
	...
	private @Named("boolean_wrapper") @Converted(BooleanWrapperConverter.class) Wrapper<Boolean> booleanWrapper;
	private @Named("byte_wrapper") @Converted(ByteWrapperConverter.class) Wrapper<Byte> byteWrapper;
